...
def conv_noise_test():
  return (
      ...
      # dict(
      #     testcase_name="base_case_weight_noise",
      #     examples=128,
      #     dimX=28,
      #     dimY=28,
      #     dimX_out=28,
      ...
      # ),
      # dict(
      #     testcase_name="base_case_act_noise",
      #     examples=128,
      #     dimX=28,
      #     dimY=28,
      #     dimX_out=28,
      ...
      # ),
      # dict(
      #     testcase_name="base_case_err_inpt_noise",
      #     examples=128,
      #     dimX=28,
      #     dimY=28,
      #     dimX_out=28,
...
class QuantConvTest(parameterized.TestCase):
  ...
  @parameterized.named_parameters(*conv_noise_test())
  def test_QuantConv_Noise(
      self,
      examples,
      dimX,
      dimY,
