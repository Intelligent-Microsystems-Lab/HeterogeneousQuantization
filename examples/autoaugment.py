# Copied from https://github.com/Mistobaan/tpu/blob/master/models/official/\
...
def autocontrast(image):
  ...
  def scale_channel(image):
    ...
    # TODO: A possibly cheaper version can be done using
    # cumsum/unique_with_counts over the histogram values, rather than
    # iterating over the entire image to compute mins and maxes.
