...
def get_config():
  ...
  config.quant.stem.weight = partial, init_fn = partial(percentile_init,perc=99.999))
      uniform_static)
  config.quant.stem.act = partial, init_fn = partial(gaussian_init))
      uniform_static)
  ...
  config.quant.mbconv.weight = partial, init_fn = partial(percentile_init,perc=99.999))
      uniform_static)
  config.quant.mbconv.act = partial, init_fn = partial(gaussian_init))
      uniform_static)
  ...
  config.quant.head.weight = partial, init_fn = partial(percentile_init,perc=99.999))
      uniform_static)
  config.quant.head.act = partial, init_fn = partial(gaussian_init))
      uniform_static)

  # Average quant.
  config.quant.average = partial, init_fn = partial(gaussian_init))
      uniform_static)
  ...
  config.quant.dense.weight = partial, init_fn = partial(percentile_init,perc=99.999))
      uniform_static)
  config.quant.dense.act = partial, init_fn = partial(gaussian_init))
      uniform_static)
