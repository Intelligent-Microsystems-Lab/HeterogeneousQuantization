...
from quant import uniform_dynamic, gaussian_init
...
def get_config():
  ...
  config.quant.stem.weight = partial(
      uniform_dynamic, init_fn=gaussian_init)
  ...
  config.quant.head.weight = partial(
      uniform_dynamic, init_fn=gaussian_init)
  config.quant.head.act = partial(uniform_dynamic)
  ...
  config.quant.dense.bias = partial(uniform_dynamic, init_fn=gaussian_init)
