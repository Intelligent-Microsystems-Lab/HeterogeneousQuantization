...
from quant import parametric_quant_d_xmax
...
def get_config():
  ...
  config.quant.stem.weight = partial(parametric_quant_d_xmax, bits=8)
  config.quant.stem.act = partial(parametric_quant_d_xmax, bits=8)

  # Conv in MBConv blocks.
  config.quant.mbconv = ml_collections.ConfigDict()
  config.quant.mbconv.weight = partial(parametric_quant_d_xmax, bits=8)
  config.quant.mbconv.act = partial(parametric_quant_d_xmax, bits=8)

  # Conv for head layer.
  config.quant.head = ml_collections.ConfigDict()
  config.quant.head.weight = partial(parametric_quant_d_xmax, bits=8)
  config.quant.head.act = partial(parametric_quant_d_xmax, bits=8)

  # Average quant.
  config.quant.average = partial(parametric_quant_d_xmax, bits=8)
