...
from quant import parametric_d, percentile_init
...
def get_config():
  ...
  config.quant.stem.weight = partial(
      parametric_d, init_fn=partial(percentile_init, perc=99.9))
  config.quant.stem.act = partial(
      parametric_d, init_fn=partial(percentile_init, perc=99.9999))
