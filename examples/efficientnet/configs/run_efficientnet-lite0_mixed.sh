...
do
  ...
  if [ -d ../../efficientnet-lite0_mixed_${SIZE}_9/best ]; then
    ...
    python3 train.py --workdir=../../efficientnet-lite0_mixed_${SIZE}_finetune_7 --config=efficientnet/configs/efficientnet-lite0_mixed_finetune.py --config.pretrained_quant=../../efficientnet-lite0_mixed_${SIZE}_7/
  fi
