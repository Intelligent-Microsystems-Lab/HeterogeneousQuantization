...
def load_data_mbnet():
  ...
  state = restore_checkpoint(
      state, '/Users/clemens/Desktop/mbnetv2_mixed_4_finetune_7')
  ...
  np.save('/Users/clemens/Desktop/channel_bits_mbnet.npy',
          (bits, x['dynamic_range']))
...
def load_data_enet():
  ...
  np.save('/Users/clemens/Desktop/channel_bits.npy',
          (bits, x['dynamic_range']))
...
def plot_additional_fig():
  ...
  data_lr_t = pd.read_csv(
      'figures/training_traces/run-train-tag-learning_rate.csv', sep=',')
  data_lr_t['Step'] += data_lr['Step'].iloc[-1]
  data_lr = pd.concat([data_lr, data_lr_t], ignore_index=True)

  data_penalty_t = pd.read_csv(
      'figures/training_traces/run-train-tag-penalty_strength.csv', sep=',')
  data_penalty_t['Step'] += data_penalty['Step'].iloc[-1]
  data_penalty = pd.concat([data_penalty, data_penalty_t], ignore_index=True)

  data_lr_t = pd.read_csv(
      'figures/training_traces/finetune-learning_rate.csv', sep=',')
  data_lr_t['Step'] += data_lr['Step'].iloc[-1]
  data_lr = pd.concat([data_lr, data_lr_t], ignore_index=True)
  ...
  ax_lr.plot(data_lr['Step'], data_lr['Value'],
             label='Learning Rate', color='orange', linewidth=gen_linewidth,)
  ...
  ax_acc.set_xticks(
      [0, 25_000, 50_000, 75_000, 100_000, 125_000, 150_000, 175_000])
  ...
  data_acc = pd.read_csv(
      'figures/training_traces/pretrain-accuracy.csv', sep=',')

  data_acc_t = pd.read_csv(
      'figures/training_traces/run-train-tag-accuracy.csv', sep=',')
  data_acc_t['Step'] += data_acc['Step'].iloc[-1]
  data_acc = pd.concat([data_acc, data_acc_t], ignore_index=True)

  data_acc_t = pd.read_csv(
      'figures/training_traces/finetune-accuracy.csv', sep=',')
  data_acc_t['Step'] += data_acc['Step'].iloc[-1]
  data_acc = pd.concat([data_acc, data_acc_t], ignore_index=True)

  data_act = pd.read_csv(
      'figures/training_traces/pretrain-act_size_sum.csv', sep=',')

  data_act_t = pd.read_csv(
      'figures/training_traces/run-train-tag-act_size_sum.csv', sep=',')
  data_act_t['Step'] += data_act['Step'].iloc[-1]
  data_act = pd.concat([data_act, data_act_t], ignore_index=True)

  data_act_t = pd.read_csv(
      'figures/training_traces/finetune-act_size_sum.csv', sep=',')
  data_act_t['Step'] += data_act['Step'].iloc[-1]
  data_act = pd.concat([data_act, data_act_t], ignore_index=True)

  data_wgt = pd.read_csv(
      'figures/training_traces/pretrain-weight_size.csv', sep=',')

  data_wgt_t = pd.read_csv(
      'figures/training_traces/run-train-tag-weight_size.csv', sep=',')
  data_wgt_t['Step'] += data_wgt['Step'].iloc[-1]
  data_wgt = pd.concat([data_wgt, data_wgt_t], ignore_index=True)

  data_wgt_t = pd.read_csv(
      'figures/training_traces/finetune-weight_size.csv', sep=',')
  data_wgt_t['Step'] += data_wgt['Step'].iloc[-1]
  data_wgt = pd.concat([data_wgt, data_wgt_t], ignore_index=True)

  ax_acc.plot(data_acc['Step'], data_acc['Value'] * 100,
  ...
  bits, xmax = np.load(
      '/Users/clemens/Desktop/channel_bits.npy', allow_pickle=True)
  ...
  ax_enet.text(-9, 0.3, '# Bits', dict(size=23), rotation=90)
  ax_enet.text(-9, -.7, 'qmax', dict(size=23), rotation=90)
  ...
  bits, xmax = np.load(
      '/Users/clemens/Desktop/channel_bits_mbnet.npy', allow_pickle=True)
  ...
  ax_mbnet.text(-9, 0.3, '# Bits', dict(size=23), rotation=90)
  ax_mbnet.text(-9, -.7, 'qmax', dict(size=23), rotation=90)
