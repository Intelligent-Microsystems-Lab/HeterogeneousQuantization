...
do
  ...
  if [ -d ../../mbnetv2_mixed_${SIZE}_gran_sur_7/best ]; then
    python3 train.py --workdir=../../mbnetv2_mixed_${SIZE}_finetune_7 --config=mobilenetv2/configs/mobilenetv2_mixed_finetune_gran_sur.py --config.pretrained_quant=../../mbnetv2_mixed_${SIZE}_gran_sur_7/best
  else
    python3 train.py --workdir=../../mbnetv2_mixed_${SIZE}_finetune_7 --config=mobilenetv2/configs/mobilenetv2_mixed_finetune_gran_sur.py --config.pretrained_quant=../../mbnetv2_mixed_${SIZE}_gran_sur_7/
  fi
