...
def train_and_evaluate(config: ml_collections.ConfigDict,
  ...
  # Load Data
  train_iter, eval_iter = dataset.create_dataloader(chunk_size_train=config.chunk_size_train,
                                  chunk_size_test=config.chunk_size_test,
  ...
  if config.steps_per_eval == -1:
    num_validation_examples = len(eval_iter)
