## Yin and Yang with BPTT

Trains a SNN on the Yin and Yang task with backpropagation through time (BPTT).
...
Yin and Yang example allows specifying a hyperparameter configuration by the means of
