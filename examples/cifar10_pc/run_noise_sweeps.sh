...
python3 sweep.py --result_dir $MAIN_DIR/weight_noise_bp --start $START --stop $STOP --step $STEP --user $USER --queue $GPU_Q --parameter weight_noise --network_type bp
python3 sweep.py --result_dir $MAIN_DIR/act_noise_bp --start $START --stop $STOP --step $STEP --user $USER --queue $GPU_Q  --parameter act_noise --network_type bp
python3 sweep.py --result_dir $MAIN_DIR/err_inpt_noise_bp --start $START --stop $STOP --step $STEP --user $USER --queue $GPU_Q --parameter err_inpt_noise --network_type bp
python3 sweep.py  --result_dir $MAIN_DIR/err_weight_noise_bp --start $START --stop $STOP --step $STEP --user $USER --queue $GPU_Q --parameter err_weight_noise --network_type bp
